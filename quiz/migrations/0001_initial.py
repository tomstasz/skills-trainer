# Generated by Django 4.0.8 on 2022-12-08 09:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seniority', models.CharField(choices=[('junior', 'junior'), ('regular', 'regular'), ('senior', 'senior')], max_length=64, verbose_name='Seniority')),
                ('user_name', models.CharField(max_length=120)),
                ('email', models.CharField(max_length=120, unique=True)),
                ('number_of_questions', models.IntegerField(choices=[(6, 6), (9, 9), (12, 12)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=240, null=True, verbose_name='Text')),
